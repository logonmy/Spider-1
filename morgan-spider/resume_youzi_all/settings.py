...
project_settings = {
"PROJECT_NAME": 'resume_youzi_all',

"CALLSYSTEMID": 'morgan-youzi-resume-2',
"TASK_TYPE": 'RESUME_FETCH',
'RESOURCE_TYPE': 'RESUME_SEARCH',
"SOURCE": 'YOU_ZI',
'PROXY_PATH': 'test',

"SEARCH_THREAD_NUMBER": 3,
...
'UPDATE_DOWNLOAD_SCORE': 'http://172.16.25.35:8002/acc/uploadCookie.json',
...
def get_proxy():
    ...
    # return {'http': 'http://H8HO3L3H1G6705SD:D56EA801A63B16CF@http-dyn.abuyun.com:9020', 'https': 'https://H8HO3L3H1G6705SD:D56EA801A63B16CF@http-dyn.abuyun.com:9020'}
