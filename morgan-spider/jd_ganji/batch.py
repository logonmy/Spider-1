...
WHERE source = 'GJ_HR'
and valid = 1
AND concat(thirdFunctionURL,'_',url)
IN (%s)
'''
...
def handle():
    prop_file = open('/data/config/morgan/jd-task/ganji_city_function.properties', 'r')
    logger.info('读取文件/data/config/morgan/jd-task/ganji_city_function.properties')
    count = 0
