...
class Runner(object):
    def __init__(self):
        ...
        self.queue = RedisQueue('t_mail_by_date', host=REDIS_HOST,
                                port=REDIS_PORT)
    ...
    def producer(self):
        ...
        res = self.db.session.query(TEmail).filter(TEmail.email.in_((
            # 'wangshaofeng@lhwsm.xyz',
            # 'wangpei@lhwsm.xyz',
            # 'wangmeige@lhwsm.xyz',
            # 'xuegege@lhwsm.xyz',
            # 'xuefurong@lhwsm.xyz',
            # 'jishu.wu@1zhanpin.com',
            'wenwen.wu@1zhanpin.com',
            # 'renyuyang@mfwpkj.cn',
            # 'jishu.wu@1zhanpin.com',
        )))
